...
public class CreateAllocation {
	...
	/**
	 * Sends a create allocation request 
	 * @param contentType
	 * @param json
	 * @param url
	 */
	...
	/**
	 * Sends create allocation request using GET method
	 * @param url
	 * @param response
	 */
	...
	/**
	 * Sends a create allocation request and gets a JsonObject response
	 * @param contentType
	 * @param json
	 * @param url
	 * @return JsonObject
	...
	/**
	 * Sends a create allocation request and gets a ValidatableResponse response, in case parsing is required
	 * @param contentType
	 * @param json
	 * @param url
	 * @param statusCode
	...
	/**
	 * Sends a create allocation request and gets a String response, in case parsing is required
	 * @param contentType
	 * @param json
	 * @param url
	 * @param statusCode
	...
	/**
	 * Sends a create allocation request and asserts that correct status code is received
	 * @param contentType
	 * @param json
	 * @param url
	 * @param statusCode
	...
	/**
	 * Sends a create allocation request, asserts that correct status code is received, <br>and the correct response expected in the response body
	 * @param contentType
	 * @param json
	 * @param url
	 * @param statusCode
	...
	/**
	 * Sends a create allocation request and asserts that correct status code is received, <br>and two correct responses that are expected- are received in the response body
	 * @param contentType
	 * @param json
	 * @param url
	 * @param statusCode
